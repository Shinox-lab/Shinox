...
InteractionType = Literal[
    ...
    "SESSION_BRIEFING",
    "SQUAD_COMPLETION",
    "TASK_ASSIGNMENT",  # For task delegation from squad lead
]
...
class SystemCommandMetadata(BaseModel):
    ...
    class Config:
        extra = "allow"  # Allow additional fields from Director

class SystemCommand(BaseModel):
    id: str
    type: Literal["SYSTEM_COMMAND"]
    source: str
    timestamp: Union[int, str, datetime]  # Accept int (unix), str (ISO), or datetime

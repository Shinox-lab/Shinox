...
*   **Behavior:** They are stateful entities wrapping **LangGraph** cognitive loops. They listen to the stream, identify tasks relevant to their skills, and execute work.
*   **Protocols:**
...
|:---|:---|:--------|:------------|:---------|:-----------|:---------------|
| [ ] | **CLD-000** | **Asynchronous Task & Background Processing** | Implement "Fire-and-Forget" protocol where agents immediately acknowledge requests ("I'm on it") and execute long-running tasks (tests, research) in non-blocking background threads. Results are injected back into the stream upon completion. | P0 | High | Critical selling point; enables complex/slow agent actions |
...
| status | ID | Agent Type | Description | Core Capabilities | Integration Points | Priority |
|:---|:---|:-----------|:------------|:------------------|:-------------------|:---------|
...
| statsu | ID | Integration Category | Specific Integrations | Description | Priority |
|:---|:---|:--------------------|:---------------------|:------------|:---------|
